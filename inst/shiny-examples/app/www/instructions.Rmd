...
```{css, echo=FALSE}
/* Customize the style of the TOC float */
#toc_float {
  position: fixed;
  top: 100px;
  right: 50px;
...
/* Customize the style of the TOC links */
#toc_float a {
  color: #337ab7;
...
| **abstract**          | A summary or brief description of the publication                                                                                      |
...
5.  If you want to assign a label or source to individual files, you can do so by going to the *add labels/sources* tab
...
IAs you can see, when a citation was present across multiple sources this is indicated in the source output. This is because of the way ASySD merges duplicate citations together.
