...
```{r}
results <- dedup_citations(all_citations, merge=TRUE, keep_source = "old")
```
...
```{r}
final_results <- dedup_citations_add_manual(all_citations, additional_pairs = true_duplicates, merge_citations = TRUE, keep_source = "old")
```
